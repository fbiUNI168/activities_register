...
TEST(activityTest, constructorTest) {
    Activity activity("", Date(16, 8, 2024),
                      Time(17, 30), Time(18, 00));
    ASSERT_EQ(activity.getDate(), Date(16, 8, 2024));
    ASSERT_EQ(activity.getDescription(), "Activity");
...
TEST(activityTest, settersTest){
    Activity activity("Do the project for the programming course", Date(16, 8, 2024),
                      Time(17, 30), Time(18, 00));
    ...
    EXPECT_THROW(activity.setStartTime(Time(18, 10)), std::invalid_argument);
    EXPECT_THROW(activity.setEndTime(Time(17, 15)), std::invalid_argument);
}

TEST(ActivityTest, isOverlappingTest){
    Activity firstActivity("Do the project for the programming course", Date(16, 8, 2024),
                      Time(17, 30), Time(18, 00));
    Activity secondActivity("Do the project for the programming course", Date(16, 8, 2024),
